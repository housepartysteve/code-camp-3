    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h1 class="display-3">Why Code?</h1><br><br>
            </div>
        </div>
        <div class="row">
            <div class="col-md-3" id="sidebar">
                <div class="list-group">
                    ...
                    <a href="{{ url('/skills') }}" class="list-group-item active">Step 4 - Why coding?</a>
            ...
            <div class="col-md-8" id="skillsMain">
                <div class="card">
                    <div class="card-header">
                        <h4><strong>Why learn coding?</strong></h4>
                    </div>
                    <div class="card-block">
                        <p class="card-text">
                            Coding is fun and very exciting once you get started you will learn fast!
                            Html and css, you won't know what these mean yet but they are very useful and rewarding to learn.
                            Coding skills will make you adventurous and make you think more!
                        </p>
                    </div>
                </div>
            </div>
